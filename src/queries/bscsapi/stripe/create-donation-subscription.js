...
const createDonationSubscription = (cancelToken, amount, frequency, source_id) => {
  return axios({
    ...
    data: {
      query: `
        query {
          createStripeCustomerDonationSubscription(amount: ${amount}, frequency: "${frequency}", sourceId: "${source_id}") {
            id
            status
          }
        }
