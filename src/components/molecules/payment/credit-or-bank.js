...
const CreditOrBank = class extends Component {
  render() {
    return (
      <React.Fragment>
        <Alert variant="warning"><i class="fas fa-exclamation-triangle"></i>&nbsp;Download SVGPerfect for when you want to use just one icon as a vector on the desktop or in your own icon workflow.Listicle iPhone chicharrones umami before they sold out freegan art party tilde hammock glossier. Readymade brunch retro raclette mumblecore. Wolf tilde paleo synth. Hot chicken dreamcatcher readymade vape. Cornhole master cleanse poke echo park pop-up tacos before they sold out man braid twee distillery tote bag. Cold-pressed knausgaard live-edge chillwave gentrify humblebrag. Schlitz polaroid disrupt twee DIY bespoke.</Alert>
