...
The report is freely available here: <Link className="btn btn-outline-secondary" target="_blank" to="/resources/reports/designing-citizen-science-for-both-science-and-education">Access Report</Link>
